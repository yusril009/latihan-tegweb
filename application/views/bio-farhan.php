                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="card-text">
                                    ...
                                    Jl.Babakan Muncang Kidul
                                </p> <!-- alamat end -->

                                <p class="card-text">
                                    <span class="text-muted mb-1 d-block">Alamat Email</span>

                                    <i class="fa-solid fa-envelope me-2 text-success"></i> farhanfadilah2001@gmail.com

                                </p> <!-- alamat email end -->

                                <p class="card-text">
                                    <span class="text-muted mb-1 d-block">Nomor Telepon</span>
                                    <i class="fa-solid fa-phone me-2 text-success"></i> +62 81221591859
                                </p> <!-- nomor telepon end -->
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="https://pointblank.com/id-id/" target="_blank" class="text-decoration-none link-success">
                                    <i class="fa-solid fa-globe me-2 text-success"></i> https://pointblank.com/id-id/
                                </a>
