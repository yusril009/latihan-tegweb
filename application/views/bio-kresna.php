            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="shadow border rounded p-5 mb-5">
                        ...
                        <p>Saya merupakan mahasiswa aktif Universitas Jenderal Achmad Yani</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="card-text">
                                    ...
                                    Jl.Sanghyang Pancanaka Hill
                                </p> <!-- alamat end -->

                                <p class="card-text">
                                    <span class="text-muted mb-1 d-block">Alamat Email</span>

                                    <i class="fa-solid fa-envelope me-2 text-success"></i> kresnawijaksana@gmail.com

                                </p> <!-- alamat email end -->

                                <p class="card-text">
                                    <span class="text-muted mb-1 d-block">Nomor Telepon</span>
                                    <i class="fa-solid fa-phone me-2 text-success"></i> +62 89526770843
                                </p> <!-- nomor telepon end -->
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="https://playvalorant.com/id-id/" target="_blank" class="text-decoration-none link-success">
                                    <i class="fa-solid fa-globe me-2 text-success"></i> https://playvalorant.com/id-id/
                                </a>
